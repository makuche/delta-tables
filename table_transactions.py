...
import argparse
from io_ import _init_spark, save_history_to_html, print_table, _remove_table_if_exists
...
def main(print_table: bool, reset_table: bool) -> None:
    ...
    if print_table: print_table(delta_table)
    ...
    save_history_to_html(delta_table, "logs/history.html")
    spark.stop()
